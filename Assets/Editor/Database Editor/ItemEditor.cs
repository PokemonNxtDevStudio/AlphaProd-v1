...
{
    public class ItemEditor : DatabaseEditorBase<InventoryItem>
    {
        ...
        protected override List<InventoryItem> crudList
        {
            get { return new List<InventoryItem>(EditorUtils.selectedDatabase.ItemsList); }
            set { EditorUtils.selectedDatabase.ItemsList = value; }
        }
        ...
        protected override bool MatchesSearch(InventoryItem item, string searchQuery)
        {
        ...
        protected override void CreateNewItem()
        {
            ...
            var picker = CreateNewItemEditor.Get((System.Type type, GameObject obj, EditorWindow thisWindow) =>
            {
                ...
                var comp = (InventoryItem)prefab.AddComponent(type);
        ...
        {
            AssetDatabase.DeleteAsset(AssetDatabase.GetAssetPath(EditorUtils.selectedDatabase.ItemsList[0]));
            base.RemoveItem(i);
        }

        public override void EditItem(InventoryItem item)
        {
            base.EditItem(item);
        ...
        protected override void DrawSidebarRow(InventoryItem item, int i)
        {
            int checkedCount = 0;
            foreach (var type in allItemTypes)
            {
        ...
        protected override void DrawDetail(InventoryItem item, int index)
        {
