...
public class MotorController : MonoBehaviour
{
    ...
    public MotorState motorState = MotorState.None;
    ...
    {
    if(motorState == MotorState.None)
    {
        Debug.Log("Define type or motor Input or AI on " + gameObject.name);
    }
        m_speed = baseSpeed;
    ...
    public void FaceCamera()
    {
        ...
        if (mainCamera == null)
        {
            Debug.Log(gameObject.name + " has no type of input");
            return;
        }
