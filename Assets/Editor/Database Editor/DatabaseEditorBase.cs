...
{
    public abstract partial class DatabaseEditorBase<T> : ICustomEditorWindow where T : class
    {
        ...
        private Color createColor = new Color(0.23f, .23f, 0.23f, 0.6f);
        ...
        private const string IntialSearchQuery = "Search database for ..";
        public bool isSearching
        {
            get { return searchQuery != "" && searchQuery != IntialSearchQuery; }
        }

        public DatabaseEditorBase(string singleName, string pluralName, EditorWindow window)
        {
        ...
        {
            EditorGUILayout.BeginVertical(DatabaseEditorStyles.boxStyle, GUILayout.Width(375.0f));
        }
        ...
        {
            searchQuery = DatabaseEditorStyles.SearchBar(searchQuery, window, isSearching);
            ...
            if (GUILayout.Button("Create " + singleName, (GUIStyle)"Button"))
                CreateNewItem();
