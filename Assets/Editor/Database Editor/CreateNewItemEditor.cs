...
public class CreateNewItemEditor : EditorWindow
{


    private Editor itemPicker;

    private ItemTypePicker picker { get; set; }
    ...
    public void OnGUI()
        {
            ...
            if(forceFocus)
                EditorWindow.FocusWindowIfItsOpen<ItemTypePicker>();
